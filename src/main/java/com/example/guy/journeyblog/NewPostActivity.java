...
public class NewPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newPostToolBar.setTitle("Add New Post");
        ...
        newPostBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!TextUtils.isEmpty(desc) && postImageUri!=null)
                {
                    ...
                    filePath.putFile(postImageUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                            ...
                            if(task.isSuccessful())
                            {
                                ...
                                try {
                                    compressorImageFile = new Compressor(NewPostActivity.this).setMaxHeight(100).setMaxWidth(100)
                                ...
                                uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                    ...
                                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                        ...
                                        postMap.put("dest",desc);
                                        postMap.put("user_id",current_user_id);
                                        FieldValue timestamp = FieldValue.serverTimestamp();
                                        postMap.put("timestamp",timestamp);
                                        //If we want google map its Here !!
                                        //TODO
                    ...
                    Toast.makeText(NewPostActivity.this,getString(R.string.entervalue),Toast.LENGTH_LONG).show();
            }
        });
        newPostImage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Dont need to check premission , user already got.
                CropImage.activity().setGuidelines(CropImageView.Guidelines.ON).setAspectRatio(1,1).setMinCropResultSize(512,512).start(NewPostActivity.this);
